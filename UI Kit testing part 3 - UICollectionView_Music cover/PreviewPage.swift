...
class PreviewPage: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        // WE DONT NEED IT BECAUSE WE MADE OUR OWN CLASS 
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            ...
            if let indexPath = self.collectionView.indexPathsForSelectedItems {
                let secondPageVC = segue.destination as! SecondPage
                let numberofCell = indexPath[0].row
                secondPageVC.trackTitle = imageNameArray[numberofCell]
            }
        }
    }
